...
public class R__10_Insert_register_metadata extends BaseJdbcMigration implements MigrationChecksumProvider {
    ...
    private static org.slf4j.Logger LOG = LoggerFactory.getLogger(R__10_Insert_register_metadata.class);
    ...
    public void migrate(Connection connection) throws Exception {
        ...
        try {
            ...
            writeRecords(connection, allRecordsFixedEntryNumbers);
        } catch (Exception e) {
            LOG.error("", e);
        } finally {
    ...
    private void writeRecords(Connection connection, Iterable<Record> records) throws SQLException {
