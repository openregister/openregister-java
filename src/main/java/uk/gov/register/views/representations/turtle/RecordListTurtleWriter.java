...
public class RecordListTurtleWriter extends TurtleRepresentationWriter<RecordListView> {
    ...
    protected Model rdfModelFor(RecordListView view) {
        ...
        view.getRecords().forEach(r -> model.add(new RecordTurtleWriter(requestContext, itemConverter, registerData, registerNameConfiguration, registerResolver).rdfModelFor(r)));
        return model;
    }
}
