...
public class RecordTurtleWriter extends TurtleRepresentationWriter<RecordView> {
    ...
    @Inject
    public RecordTurtleWriter(javax.inject.Provider<EverythingAboutARegister> aboutARegisterProvider, RegisterResolver registerResolver) {
    ...
    protected Model rdfModelFor(RecordView view) {
        ...
        Model entryModel = new EntryTurtleWriter(aboutARegisterProvider, registerResolver).rdfModelFor(entry, false);
        Model itemModel = new ItemTurtleWriter(aboutARegisterProvider, registerResolver).rdfModelFor(itemView);
