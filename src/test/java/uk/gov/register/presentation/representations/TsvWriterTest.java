...
public class TsvWriterTest {
    ...
    public void tsv_entriesAreGenerated() throws IOException {
        ...
        writer.writeTo(new ResourceBase(){}.new ListResultView("don't care", Collections.singletonList(record)), List.class, null, null, ExtraMediaType.TEXT_CSV_TYPE, null, stream);
