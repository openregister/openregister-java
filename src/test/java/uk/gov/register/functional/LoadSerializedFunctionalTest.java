...
public class LoadSerializedFunctionalTest {
    ...
    public void checkMessageIsConsumedAndStoredInDatabase() throws Exception {
        ...
        assertThat(systemEntries.get(1).getBlobHashes().get(0).getValue(), is("ceae38992b310fba3ae77fd84e21cdb6838c90b36bcb558de02acd2f6589bd3f"));
        assertThat(systemEntries.get(2).getEntryNumber(), is(3));
        assertThat(systemEntries.get(2).getBlobHashes().get(0).getValue(), is("4624c413d90e125141a92f28c9ea4300a568d9b5d9c1c7ad13623433c4a370f2"));
        assertThat(systemEntries.get(3).getEntryNumber(), is(4));
        assertThat(systemEntries.get(3).getBlobHashes().get(0).getValue(), is("1c5a799079c97f1dcea1b244d9962b0de248ba1282145c2e815839815db1d0a4"));
        assertThat(systemEntries.get(4).getEntryNumber(), is(5));
        assertThat(systemEntries.get(4).getBlobHashes().get(0).getValue(), is("c7e5a90c020f7686d9a275cb0cc164636745b10ae168a72538772692cc90d633"));
        assertThat(systemEntries.get(5).getEntryNumber(), is(6));
        assertThat(systemEntries.get(5).getBlobHashes().get(0).getValue(), is("61138002a7ae8a53f3ad16bb91ee41fe73cc7ab7c8b24a8afd2569eb0e6a1c26"));
        ...
        assertThat(userEntries.get(1).getBlobHashes().get(0).getValue(), is("b8b56d0329b4a82ce55217cfbb3803c322bf43711f82649757e9c2df5f5b8371"));
