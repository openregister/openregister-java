...
public class BaseEntryIteratorFunctionalTest {
    ...
    public void testCanIterateInOrder() {
        register.loadRsf(TestRegister.register, "add-item\t{\"fields\":[\"field1\"],\"register\":\"value1\",\"text\":\"The BaseEntry 1\"}\n" +
    ...
    public void testCanStillIterateAfterIteratorEndsThenNewEntriesAdded() {
        EntryIterator.withEntryIterator(entryQueryDAO, entryIteratorDAO -> {
            ...
            register.loadRsf(TestRegister.register, "add-item\t{\"fields\":[\"field1\",\"field2\"],\"register\":\"value2\",\"text\":\"The BaseEntry 2\"}\n" +
                    "append-entry\tuser\tvalue2\t2016-03-02T02:03:04Z\tsha-256:63e5a0453b088e39265ca9f20fd03e2b206422e32989649adaca84426b531cd7\n");
    ...
    public void testCanStillIterateAfterIteratorDoesNotThenNewEntriesAddedd() {
        EntryIterator.withEntryIterator(entryQueryDAO, entryIteratorDAO -> {
            ...
            register.loadRsf(TestRegister.register, "add-item\t{\"fields\":[\"field1\",\"field2\",\"field3\"],\"register\":\"value3\",\"text\":\"The BaseEntry 3\"}\n" +
