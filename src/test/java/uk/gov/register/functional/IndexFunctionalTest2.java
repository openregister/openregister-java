...
public class IndexFunctionalTest2 {
    @ClassRule
    ...
    public void setup() throws IOException {
        ...
        register.wipe();
        String inputRsf = new String(Files.readAllBytes(Paths.get("src/test/resources/fixtures/example1", "input.rsf")));
    ...
    public void shouldAllowDownloadOfIndexAsRsf() throws IOException {
        String expectedIndexRsf = new String(Files.readAllBytes(Paths.get("src/test/resources/fixtures/example1", "index.rsf")));
    ...
    public void shouldDisplyIndexRecordsAsJson() throws IOException {
        String expectedRecords = new String(Files.readAllBytes(Paths.get("src/test/resources/fixtures/example1/records", "5.json")));
