...
public class PreviewRecordsResourceFunctionalTest {
    ...
    public void getJsonPreview() throws IOException {
        final Response response = register.getRequest(address, "/preview-records/json");
        final String entity;
    ...
    public void getYamlPreview() throws IOException {
        final Response response = register.getRequest(address, "/preview-records/yaml");
        final String entity;
    ...
    public void getTtlPreview() throws IOException {
        final Response response = register.getRequest(address, "/preview-records/turtle");
        final String entity;
