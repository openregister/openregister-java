...
public class PreviewEntriesResourceFunctionalTest {
    ...
    public void getJsonPreview() throws IOException {
        final Response response = register.getRequest(address, "/preview-entries/json");
        final String entity;
    ...
    public void getYamlPreview() throws IOException {
        final Response response = register.getRequest(address, "/preview-entries/yaml");
        final String entity;
    ...
    public void getTtlPreview() throws IOException {
        final Response response = register.getRequest(address, "/preview-entries/turtle");
        final String entity;
    ...
    @Test
    public void getJsonPreview_singleElement() throws IOException {
        final Response response = register.getRequest(address, "/preview-entries/json/1");
        final String entity;
    ...
    @Test
    public void getYamlPreview_singleElement() throws IOException {
        final Response response = register.getRequest(address, "/preview-entries/yaml/1");
        final String entity;
    ...
    @Test
    public void getTtlPreview_singleElement() throws IOException {
        final Response response = register.getRequest(address, "/preview-entries/turtle/1");
        final String entity;
