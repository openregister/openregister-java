...
public class ArchiveCreatorTest {
    ...
    public void create_shouldCreateAnArchiveWithRegisterInfoEntriesAndItems() throws IOException {
        ...
        assertThat(actualEntry1Node.get("item-hashes").get(0).asText(), equalTo("sha-256:entry1sha"));
        ...
        assertThat(actualEntry2Node.get("item-hashes").get(0).asText(), equalTo("sha-256:entry2sha"));
