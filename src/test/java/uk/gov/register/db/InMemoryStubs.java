...
public abstract class InMemoryStubs {
    public static EntryLog inMemoryEntryLog(InMemoryEntryQueryDAO entryQueryDAO) {
        return new InMemoryEntryLog(new DoNothing(), entryQueryDAO, entryQueryDAO);
    }

    public static ItemStore inMemoryItemStore(ItemValidator itemValidator, InMemoryEntryQueryDAO entryQueryDao) {
