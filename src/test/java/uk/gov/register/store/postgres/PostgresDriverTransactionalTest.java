...
public class PostgresDriverTransactionalTest extends PostgresDriverTestBase {
    ...
    public void getTotalEntriesShouldNotCommitStagedDataButCountStagedData() {
        ...
        entries.add(new Entry(1, new HashValue(HashingAlgorithm.SHA256, "itemhash1"), Instant.now()));
        ...
        postgresDriver.insertEntry(new Entry(2, new HashValue(HashingAlgorithm.SHA256, "itemhash2"), Instant.now()));
        ...
        postgresDriver.insertEntry(new Entry(3, new HashValue(HashingAlgorithm.SHA256, "itemhash3"), Instant.now()));
        postgresDriver.insertRecord(mockRecord("country", "VA", 2), "country");
