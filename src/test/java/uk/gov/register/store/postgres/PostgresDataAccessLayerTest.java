...
public class PostgresDataAccessLayerTest {
    ...
    public void canGetRecordsByKeyValue() throws IOException {
        ...
        assertThat(postgresDataAccessLayer.findRecordsByKeyValue(EntryType.user, "field", "value1", 100, 0).size(), is(1));
        assertThat(postgresDataAccessLayer.findRecordsByKeyValue(EntryType.user, "field", "value1", 100, 0), contains(userRecord1));
        assertThat(postgresDataAccessLayer.findRecordsByKeyValue(EntryType.user, "field", "value2", 100, 0).size(), is(2));
        assertThat(postgresDataAccessLayer.findRecordsByKeyValue(EntryType.user, "field", "value2", 100, 0), contains(userRecord3, userRecord2));
        assertThat(postgresDataAccessLayer.findRecordsByKeyValue(EntryType.user, "field", "value3", 100, 0).size(), is(0));
        assertThat(postgresDataAccessLayer.findRecordsByKeyValue(EntryType.user, "invalid-field", "value", 100, 0).size(), is(0));

        assertThat(postgresDataAccessLayer.findRecordsByKeyValue(EntryType.system, "field", "value3", 100, 0).size(), is(0));
        assertThat(postgresDataAccessLayer.findRecordsByKeyValue(EntryType.system, "field", "value4", 100, 0).size(), is(2));
        assertThat(postgresDataAccessLayer.findRecordsByKeyValue(EntryType.system, "field", "value4", 100, 0), contains(systemRecord2, systemRecord1));
        assertThat(postgresDataAccessLayer.findRecordsByKeyValue(EntryType.system, "invalid-field", "value", 100, 0).size(), is(0));
    }
}
