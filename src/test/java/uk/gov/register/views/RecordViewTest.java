...
public class RecordViewTest {
    ...
    public void recordJsonRepresentation_isFlatJsonOfEntryAndItemContent() throws IOException, JSONException {
        ...
        Record record = new Record(new Entry(1, new HashValue(HashingAlgorithm.SHA256, "ab"), Instant.ofEpochSecond(1470403440), "b"), new Item("ab", objectMapper.readTree("{\"a\":\"b\"}")));
