...
public class TurtleRepresentationWriterTest {
    ...
    public void rendersEntryIdentifierFromRequestContext() throws Exception {
        EntryView entryView = new EntryView(requestContext, null, null, new Entry(52, new HashValue(HashingAlgorithm.SHA256, "hash"), Instant.now()), () -> "test.register.gov.uk", null, () -> Optional.empty());
