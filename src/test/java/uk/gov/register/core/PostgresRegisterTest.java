...
public class PostgresRegisterTest {
    ...
    public void appendEntryShouldThrowExceptionIfNoCorrespondingItemExists() {
        Entry entryDangling = new Entry(106, "item-hash-2", Instant.now(), "key");
    ...
    public void appendEntryShouldNotInsertDanglingEntry() {
        ...
        Entry entryNotDangling = new Entry(105, "item-hash-1", Instant.now(), "key-1");
        Entry entryDangling = new Entry(106, "item-hash-2", Instant.now(), "key-2");
