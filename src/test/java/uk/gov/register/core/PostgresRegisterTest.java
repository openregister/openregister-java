...
public class PostgresRegisterTest {
    ...
    public void appendEntryShouldNotInsertDanglingEntry() throws IOException {
        ...
        PostgresRegister register = new PostgresRegister(registerMetadata("register"), registerFieldsConfiguration, entryLog, inMemoryItemStore(itemValidator, entryDAO), recordIndex);
