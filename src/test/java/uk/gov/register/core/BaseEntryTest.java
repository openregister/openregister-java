...
public class BaseEntryTest {
    ...
    public void getTimestampAsISOFormat_returnsTheFormattedTimestamp() {
        BaseEntry entry = new BaseEntry(123, new HashValue(HashingAlgorithm.SHA256, "abc"), Instant.ofEpochSecond(1470403440), "sample-key", EntryType.user);
    ...
    public void getSha256hex_returnsTheSha256HexOfItem() {
        BaseEntry entry = new BaseEntry(123, new HashValue(HashingAlgorithm.SHA256, "abc"), Instant.ofEpochSecond(1470403440), "sample-key", EntryType.user);
        assertThat(entry.getBlobHashes().get(0).getValue(), equalTo("abc"));
    }

    @Test
    public void getItemHash_returnsSha256AsItemHash() {
        BaseEntry entry = new BaseEntry(123, new HashValue(HashingAlgorithm.SHA256, "abc"), Instant.ofEpochSecond(1470403440), "sample-key", EntryType.user);
        assertThat(entry.getBlobHashes().get(0).toString(), equalTo("sha-256:abc"));
    }
    ...
    public void equals_shouldReturnTrue_whenEntriesAreEqual() {
        BaseEntry entry1 = new BaseEntry(1, hash1, Instant.parse("2017-03-10T00:00:00Z"), "key", EntryType.user);
        BaseEntry entry2 = new BaseEntry(1, hash1, Instant.parse("2017-03-10T00:00:00Z"), "key", EntryType.user);
    ...
    public void equals_shouldReturnFalse_whenKeyIsNotEqual() {
        BaseEntry entry1 = new BaseEntry(1, hash1, Instant.parse("2017-03-10T00:00:00Z"), "GB", EntryType.user);
        BaseEntry entry2 = new BaseEntry(1, hash1, Instant.parse("2017-03-10T00:00:00Z"), "US", EntryType.user);
    ...
    public void equals_shouldReturnFalse_whenTimestampIsNotEqual() {
        BaseEntry entry1 = new BaseEntry(1, hash1, Instant.parse("2017-03-10T00:00:00Z"), "key", EntryType.user);
        BaseEntry entry2 = new BaseEntry(1, hash1, Instant.parse("2020-10-10T00:00:00Z"), "key", EntryType.user);
    ...
    public void equals_shouldReturnTrue_whenItemHashesAreEqualButInDifferentOrder() {
        ...
        BaseEntry entryWithList1 = new BaseEntry(1, list1, Instant.parse("2017-03-10T00:00:00Z"), "key", EntryType.user);
        BaseEntry entryWithList2 = new BaseEntry(1, list2, Instant.parse("2017-03-10T00:00:00Z"), "key", EntryType.user);
