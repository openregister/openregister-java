...
public class NoSuchItemForEntryExceptionMapperTest {
    ...
    public void toResponse_returns400Response() {
        ...
        Response response = noSuchItemForEntryExceptionMapper.toResponse(new NoSuchItemForEntryException(new Entry(105, new HashValue(HashingAlgorithm.SHA256, "abcdeabcde"), Instant.now())));
