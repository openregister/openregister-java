...
public class EntryParserTest {
    ...
    public void invalidDataThrowsException() {
        ...
        inputGarbage.leaf_input = "non-JSON-data";
    ...
    public void validDataReturnsAValidEntryObject() {
        String validLeafData = "AAAAAAFSIJm7NoAAAACMeyAiYnVzaW5lc3MiOiAiY29tcGFueTowNzIyODEzMCIsICJlbmQtZGF0ZSI6ICIiLCAiZm9vZC1wcmVtaXNlcyI6ICI3NTkzMzIiLCAiZm9vZC1wcmVtaXNlcy10eXBlcyI6IFsgXSwgIm5hbWUiOiAiQnlyb24iLCAic3RhcnQtZGF0ZSI6ICIiIH0AAA==";

        MerkleTreeLeaf inputGarbage = new MerkleTreeLeaf();
        inputGarbage.leaf_input = validLeafData;
